...
noremap <NL> :bprev 	"Switch to prev buffer using ^left
noremap  :bnext 	"Switch to next buffer using ^left
noremap  l
snoremap  b<BS>
snoremap % b<BS>%
snoremap ' b<BS>'
...
nnoremap <F3> :source ~/.vim/session.vim " Opens session with F3
nnoremap <F2> :mksession! ~/.vim/session.vim " Quick write session with F2
...
silent only
cd /cygdrive/c/wamp/www
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 testmysql.php
badd +0 index.php
args testmysql.php
edit index.php
